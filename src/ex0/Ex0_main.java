...
import ex0.algo.Elevator_MyAlgo;
...
public class Ex0_main {
    public static Long ID0=207689621L, ID1 = null, ID2 = null;
    public static void main(String[] ar) {
        ...
        ElevatorAlgo ex0_alg = new Elevator_MyAlgo(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
